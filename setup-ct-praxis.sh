...
echo -e "${GREEN} This configuration creates one shared folder: ${NC}"
echo -e 
echo -e " /praxis - ${GREEN} owned by Samba group:${NC} $SMB_GROUP ${GREEN}with the following member:${NC} $SMB_USER"
echo
...
echo "smbclient '\\\\localhost\\praxis' -U $SMB_USER"
echo "smbclient '\\\\$IP_ADDRESS\\praxis' -U $SMB_USER"
echo "smbclient '\\\\$new_line\\praxis' -U $SMB_USER"
echo
